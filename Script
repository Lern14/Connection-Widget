...
if __name__ == "__main__":
    ...
    connections = {
        ...
        "RDP_AD123": {"type": "RDP", "host": "AD123", "port": 3389, "column": "Лок.сервера", "name": "RDP_AD123"},
        ...
        "VNC_petrov.am": {"type": "VNC", "host": "W345", "port": 5900, "column": "Пользователи_БЕЛ","name": "VNC_petrov.am"},
}

    root = tk.Tk()
    s = ttk.Style()
    connection_widget = ConnectionWidget(root, connections)
    root.mainloop()
